...
export const about = {
 ...
 text3:
  "Klinik Psikolog Nisa Demir, İstanbul Ticaret Üniversitesi Psikoloji bölümünden mezun olmuştur. Ardından İstanbul Okan Üniversitesi Klinik Psikoloji Yüksek Lisans programında lisansüstü öğrenimini tamamlamıştır. Yüksek lisans öğrenimi süresince psikanalitik yönelimli süpervizyonları almıştır ve güncelde de psikanalitik yönelimle süpervizyonlarını almakta, bu alanda danışanlarıyla görüşmelerini ve çalışmalarını aktif olarak sürdürmektedir. Klinik pratiğinde psikanalitik terapi yaklaşımını uygulamaktadır.",
};
