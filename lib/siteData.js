...
export const about = {
 ...
 text3:
  "Klinik Psikolog Nisa Demir, İstanbul Ticaret Üniversitesi Psikoloji bölümünden mezun olmuştur. Ardından İstanbul Okan Üniversitesi Klinik Psikoloji Yüksek Lisans programında lisansüstü öğrenimini tamamlamıştır. Yüksek lisans öğrenimi süresince psikanalitik yönelimli süpervizyonları almıştır. Güncel olarak da psikanalitik yönelimli süpervizyonunu almakta, klinik pratiğinde danışanlarıyla görüşme ve çalışmalarını aktif olarak bu ekolde sürdürmektedir.",
 text4:
  "Şu an psikanalitik psikoterapi çerçevesinde yetişkinlerle bireysel olmak üzere yüzyüze ve online olarak bireysel psikoterapi hizmeti vermektedir. Ayrıca, psikanalitik yönelimli bireysel terapisinden geçmekte ve mesleki süpervizyonuna devam etmektedir.",
};
