export const social = {
 email: "psikolognisademir@gmail.com",
 instagram: {
  username: "psikolognisademir",
  url: "https://instagram.com/psikolognisademir",
 },
};
...
export const about = {
 text1:
  "Uzman Klinik Psikolog Nisa Demir, İstanbul Ticaret Üniversitesi Psikoloji bölümünü 2021 yılında tamamladıktan sonra İstanbul Okan Üniversitesi Tezli Klinik Psikoloji Yüksek Lisans Programı'na 2023 yılında kabul edilmiş, Haziran 2025'te 'Romantik İlişkisi Olan Yetişkin Bireylerin Nesne İlişkileri ile Cinsel Doyum Düzeyleri Arasındaki İlişkide Obsesif Kompulsif Belirti Bozukluk Belirtilerinin Aracılık Rolünün İncelenmesi' adlı yüksek lisans tezini başarıyla savunarak 'Uzman Klinik Psikolog' unvanını almaya hak kazanmıştır.",
 text2:
  "Lisans döneminde çeşitli danışmanlık merkezlerinde staj yapmış; süreçte klinik görüşmeleri gözlemleme, danışan değerlendirme süreçlerine eşlik etme, çocukların gelişimsel ve davranışsal özelliklerini inceleme ve farklı yaş gruplarıyla yürütülen psikolojik çalışmaları takip etme fırsatı bulmuştur. Yüksek lisans döneminde Psikodinamik Psikoterapi Uygulama ve Süpervizyon dersi kapsamında Pınar Arslantürk'ten süpervizyon alarak psikoterapi çalışmalarına başlamıştır. Ardından psikanalist Yavuz Erten'in yürüttüğü 'Psikanalizden Psikodinamik Terapilere' eğitimini tamamlamıştır.",
 text3:
  "Güncel olarak yetişkinlerle bireysel psikoterapi çalışmalarını yüzyüze ve online olarak sürdürmektedir. Çalışmalarında psikanalitik psikoterapi yaklaşımından yararlanmakta; aynı zamanda kendi psikanalitik yönelimli bireysel terapi sürecine ve mesleki süpervizyonuna devam etmektedir.",
};
...
export const articles = [
 {
  title: "Ne çok yakın, ne çok uzak",
  slug: "ne-cok-yakin-ne-cok-uzak",
  image: "/",
  excerpt: "Winnicott’un “geçiş alanı” kavramı, insanların birlikte var olabildikleri, üretebildikleri ve birbirleriyle...",
  content: `Winnicott’un “geçiş alanı” kavramı, insanların birlikte var olabildikleri,
üretebildikleri ve birbirleriyle ilişki kurabildikleri ruhsal bir alandır. Çocuklukta oyun
aracılığıyla şekillenen bu alan, yaşamın ilerleyen dönemlerinde de yaratıcılığın,
yakınlığın ve ilişkinin temelini oluşturur.\n
Geçiş alanının yeterince gelişemediği, zarar gördüğü ya da hiç oluşamadığı
durumlarda ilişkilerde güçlük yaşanabilir. Çocukların oyunlarında benzer bir durumu
görürüz: Oyun sık sık yarıda kalır, çatışmalar ortaya çıkar ya da oyunculardan biri
diğerinin alanını tamamen işgal eder, bütün oyuncakları ötekinden alır ve kendi başına
oynamaya başlar. Böyle durumlarda ya ıssızlık hâkimdir ya da taraflardan biri kendi
canlılığını, yaratıcılığını ve özgünlüğünü oyuna katamaz; ötekinin esiri olmuştur.\n
Oysa geçiş alanı herkes için yeterince güvenli ve canlı olduğunda, oyundan da
ilişkiden de keyif alınabilir. Sağlıklı bir geçiş alanında kişiler hem birlikte olabilir
hem de kendi bireyselliklerini koruyabilirler. İstediklerinde yakınlaşabilir ve bir takım
olabilir, istediklerinde kendi alanlarına çekilebilirler. Bu nedenle geçiş alanı yalnızca
oyunun değil, güvenli ilişkilerin de temelidir. İlişkilerdeki ne çok yakın ne de çok
uzak olan o güvenli mesafe, bir ölçüde bu alanın varlığıyla sağlanabilir.\n
Yetişkin ilişkilerinde de benzer bir durumla karşılaşırız. Bazı ilişkilerde kişiler ya
birbirlerine aşırı yakınlaşarak kendi bireyselliklerini kaybeder ya da yakınlaşmaktan
kaçınarak yalnız kalırlar. Oysa sağlıklı ilişkilerde hem yakınlık hem de ayrılık için yer
vardır. Kişi sevdiği insanla bir arada olabilirken aynı zamanda kendi düşüncelerini,
isteklerini ve yaratıcılığını da koruyabilir. Geçiş alanı tam da bu dengeyi anlatan
ruhsal bir zemin olabilir. Belki de bir ilişkinin kişiye ne kadar alan açtığını,
birlikteyken kendimiz olarak kalabilip kalamadığımıza bakarak anlayabiliriz.\n
Ancak romantik ilişkiler söz konusu olduğunda, bu dengeyi korumak her zaman kolay
değildir. Çünkü aşk, yalnızca iki kişinin karşılaşması değil; aynı zamanda en eski
ihtiyaçlarımızın, özlemlerimizin ve eksikliklerimizin de yeniden canlandığı bir
karşılaşmadır. Bu nedenle sevdiğimiz kişiyle yakınlaşmak bazen onunla ilişki
kurmaktan çok, onunla bir, tek ve bütün olmayı istemek gibi yaşanabilir.\n
Belki de bu yüzden romantik ilişkilerde en sık karşılaşılan güçlüklerden biri, ötekine
yaklaşmayı arzularken kendimiz olarak kalabilmektir. Çünkü aşk, birbirine tutunmak
değil, birbirinin ayrı ve eksik kalmasına izin verebilmektir. Tamlık fantezisinden
vazgeçebilmek. Belki de geçiş alanının yetişkin ilişkilerindeki en önemli işlevlerinden
biri ve hatta sevmenin en güç yanı da budur; bir başkasına yakın olurken kendimiz
olarak kalabilmek.`,
 },
 {
  title:
  ...
  image: "/mucevher.jpg",
  excerpt:
   "Rapprochement döneminde çocuk ayağa kalkar, yürümeye başlar, elini kullanır ve dünyayı keşfeder. Artık yalnızca ...",
  content: `Rapprochement döneminde çocuk ayağa kalkar, yürümeye başlar, elini kullanır ve
...
ancak duygusal olarak aynı kesinlik hissedilmez. Uçağa binince eşini aramak zorunda
...
Can Yücel`,
 ...
 },
 {
  ...
  content: `Ebeveyn, çocuğa tutma (holding), beraber yaşama (living with) ve birlikte yaşama (living together) desteği sunar. Yaşamın başlangıcında çocuğun kendine bakma yeteneği yoktur; bakım verenler bu görevi onun adına üstlenir. Ancak zamanla çocuk, dereceli hayal kırıklıklarıyla bakım verenin egosundan ve bakımından ayrılmaya başlar. Bebeklik dönemindeki kusursuz gibi görünen hizmet aksamaya uğrar. Çocuğun kendi egosunun gelişebilmesi için bu aksamalar kaçınılmazdır.\nİlk bakımı verenler her zaman o özel dikkati gösteremez. Çocuk bir süre beklemek zorunda kalır, ihtiyacı anında karşılanmaz, bakım veren her zaman erişilebilir olmaz. Bu durum başlangıçta iç dünyada bir dağılma hissi yaratır. Ancak paradoksal biçimde, gelişim de tam burada başlar.\nNasıl ki kesilen göbek bağının geride kalan parçası zamanla kurur ve düşerse, çocuk da bakım verene olan mutlak bağımlılığından yavaş yavaş ayrılır. Eğer göbek bağı hiç kesilmezse yaşam sürdürülemez. Benzer şekilde, bakım veren ile çocuk arasındaki ilk simbiyotik bağın da zamanla gevşemesi gerekir. Çünkü çocuğun kendi ruhsal yapısını kurabilmesi için, bakım verenin her an her ihtiyacı karşılayan konumundan çekilmeye başlaması gerekir. Bir aksama yaşanır ve böylece ego gelişimi başlar.\nBu ayrılık bir kayıp içerir. Çocuk, bir zamanlar kendisini bütünüyle kuşatan o güven verici bakımın artık eskisi gibi olmadığını deneyimler. Ancak tam da bu kayıp sayesinde kendi içsel kaynaklarını geliştirmeye başlar. “Ego, küllerinden doğan bir phoenix (feniks) kuşudur” der Freud, Yas ve Melankoli’de mitolojiye atıfta bulunarak. Bir kayıp yaşanır; temel bakım ve o güven veren holding hissi yavaş yavaş ortadan kalkar. Çocuk ise bu süreçte kendine bakmayı öğrenir. Bir anlamda ego, kaybedilen bakımın ardından ortaya çıkan yeni bir ruhsal örgütlenmedir.\nEgo, insanın içsel düzenleyicisi, içsel bakıcısıdır. Gerçekliği algılar, uyum sağlar, öğrenir, muhakeme eder ve planlar. Bir taraftan insanı sakinleştirir, yönlendirir, dürtülerini düzenler ve kaygısını yatıştırır. Bir zamanlar bu işlevleri bebeğin gazını çıkaran, üşüdüğünde ısıtan, korktuğunda yatıştıran bakım veren yerine getirirken; zamanla bu sorumluluğu ego üstlenir. Belki de bu nedenle ego, dışarıdaki bakımın içeride yaşamaya devam eden hâlidir. Bir zamanlar dışarıdan gelen destek, zamanla iç dünyada bir yapıya dönüşür.\n
  Psikopatolojinin ağır seyrettiği durumlarda, özellikle psikozda, egonun bu bütünleştirici yapısı dağılabilir. Özbakım düşer. Kişi dişlerini fırçalamaz ve bunun farkında değildir. Kokar ama koktuğunu bilmez. Günlerce aç kalabilir ama açlığını hissedemez. Riskli davranışlarda bulunur, balkon kenarında yürür ve tehlikenin farkına varmaz. Bu durum hem dışarıda “dikkat et”, “yemeğini ye”, “kendine bak” diyecek bir sesin eksikliğini hem de içeride aynı işlevi üstlenecek ruhsal mekanizmanın çalışmamasını gösterir. Orada artık ego devrede değildir.\n
  Belki de büyümek, dışarıdaki bakım verenin sesini yavaş yavaş içselleştirebilmektir.\n
  Bir zamanlar bize “üşüdün mü?”, “acıktın mı?” diye soran ses, zamanla kendi içimizde konuşmaya başlar. Ego dediğimiz yapı da biraz böyle oluşur: Bir zamanlar dışarıda olan bakımın içeride yaşamaya, konuşmaya devam etmesiyle.`,
 },
];

export const faqCategories = [
 { slug: "terapi-sureci", title: "Terapi Süreci" },
 { slug: "online-terapi", title: "Online Terapi" },
 { slug: "basvuru", title: "Başvuru" },
 { slug: "gizlilik", title: "Gizlilik ve Etik" },
 { slug: "ucret", title: "Ücret ve Sigorta" },
];

export const faq = [
 {
  category: "terapi-sureci",
  question: "Terapi seansları ne kadar sürer?",
  answer:
   "Bireysel terapi seansları genellikle 50 dakika sürer. Seans süresi, çalışma biçimine ve o gün ele alınan konuya göre küçük farklılıklar gösterebilir; ancak standart uygulama 50 dakikalık seanslardır.",
 },
 {
  category: "online-terapi",
  question: "Online terapi yüz yüze terapi kadar etkili midir?",
  answer:
   "Araştırmalar, uygun koşullarda yürütülen online terapinin birçok durumda yüz yüze terapi kadar etkili olabildiğini göstermektedir. Önemli olan, görüşmenin güvenli, mahrem ve kesintisiz bir ortamda gerçekleşmesidir. İlk değerlendirme sonrasında sizin için en uygun görüşme biçimini birlikte belirleriz.",
 },
 {
  category: "basvuru",
  question: "Psikoterapiye ne zaman başvurmalıyım?",
  answer:
   "Kaygı, depresif duygu durum, ilişki sorunları, özgüven eksikliği, yaşam krizleri veya tekrarlayan duygusal zorlanmalar yaşıyorsanız terapiye başvurabilirsiniz. Belirli bir tanıya sahip olmanız gerekmez; kendinizi anlamak ve yaşam kalitenizi artırmak istemeniz yeterli bir başlangıç nedenidir.",
 },
 {
  category: "terapi-sureci",
  question: "Seanslar ne sıklıkla yapılır?",
  answer:
   "Psikodinamik/psikanalitik yaklaşımda seanslar genellikle haftada bir kez planlanır. Bu sıklık, sürecin derinliğini korumak ve terapötik ilişkinin sürekliliğini sağlamak açısından önemlidir. İhtiyaç ve koşullara göre sıklık birlikte değerlendirilebilir.",
 },
 {
  category: "terapi-sureci",
  question: "İlk seans nasıl geçer?",
  answer:
   "İlk seansta sizin başvuru nedeninizi, beklentilerinizi ve yaşam öykünüze dair temel bilgileri birlikte ele alırız. Bu görüşme, terapi sürecinin uygunluğunu değerlendirmek ve sizin için doğru çalışma biçimini belirlemek amacıyla yapılır. Herhangi bir baskı veya zorunluluk hissetmeniz gerekmez.",
 },
 {
  category: "terapi-sureci",
  question: "Terapi ne kadar sürer?",
  answer:
   "Terapi süresi kişiden kişiye ve ele alınan konulara göre değişir. Bazı zorlanmalar daha kısa süreli çalışmalarla ele alınabilirken, psikodinamik yaklaşımda daha derin ve uzun soluklu bir süreç söz konusu olabilir. Süreç boyunca ilerlemenizi birlikte değerlendiririz.",
 },
 {
  category: "gizlilik",
  question: "Görüşmeler gizli midir?",
  answer:
   "Evet. Terapi sürecinde paylaştığınız tüm bilgiler mesleki etik kurallar ve gizlilik ilkeleri çerçevesinde korunur. Yasal zorunluluklar dışında, açık rızanız olmadan üçüncü kişilerle paylaşılmaz.",
 },
 {
  category: "ucret",
  question: "Sigorta kapsamında mı?",
  answer:
   "Özel sağlık sigortalarının psikoterapi kapsamı poliçeden poliçeye değişmektedir. Randevu öncesinde sigorta şirketinizle görüşerek kapsamı netleştirmenizi öneririm. Seans ücretleri hakkında detaylı bilgi için iletişim kanallarından bana ulaşabilirsiniz.",
 },
 {
  category: "gizlilik",
  question: "Acil bir durumda ne yapmalıyım?",
  answer:
   "Terapi acil müdahale hizmeti değildir. Kendinize veya başkasına zarar verme riski hissediyorsanız 112'yi arayın veya en yakın acil servise başvurun. Ayrıca 182 (İntihar Önleme Hattı) veya Alo 183 (Aile, Kadın, Çocuk ve Engelli Danışma Hattı) numaralarından destek alabilirsiniz.",
 },
 {
  category: "terapi-sureci",
  question: "Eşim veya partnerim seanslara katılabilir mi?",
  answer:
   "Bireysel terapi süreci kişiye özeldir ve seanslara yalnızca danışan katılır. İlişki sorunları için çift terapisi farklı bir çalışma biçimidir. İhtiyacınıza göre uygun yönlendirme yapılabilir; bu konuyu ilk görüşmede birlikte değerlendirebiliriz.",
 },
];
